        ...
        <>
            <div className="App">
                ...
                <Routes>
                    ...
                    <Route path="/login"
                           element={<div><Helmet><title>ConsumerGram | Login</title></Helmet><Login/></div>}/>

                    <Route path="/PublicProfile"
                           element={<div><Helmet><title>ConsumerGram | Public Profile</title></Helmet><PublicProfile/>
                           </div>}/>
                    <Route path="/MakePublicProfile"
                           element={<div><Helmet><title>ConsumerGram | Make Public Profile</title>
                    ...
                    <Route path="/changeUserData"
                           element={<div><Helmet><title>ConsumerGram | Change User Data</title></Helmet>{isAuth ?
                               <ChangeUserData/> :
                               <Navigate to="/login"/>}</div>}/>
                    ...
                    <Route path="/PublicProfile/:username"
                           element={<div><Helmet><title>ConsumerGram | Profile </title></Helmet><PublicProfile/>
                           </div>}/>
                    ...
                    <Route path="/Contact"
                           element={<div><Helmet><title>ConsumerGram | Contact </title></Helmet><ContactPage/>
                           </div>}/>
